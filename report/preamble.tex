...
\newmdtheoremenv[nobreak=true]{propriete}[consequence]{Property}
\newmdtheoremenv[nobreak=true]{proprietes}[consequence]{Properties}
\newmdtheoremenv[nobreak=true]{lemme}[consequence]{Lemma}
\newmdtheoremenv[nobreak=true]{proposition}[consequence]{Proposition}
\newmdtheoremenv[nobreak=true]{theoreme}[consequence]{Theoreme}
\newmdtheoremenv[nobreak=true]{loi}[consequence]{Law}
\newmdtheoremenv[nobreak=true]{postulat}[consequence]{Postulat}
\newmdtheoremenv{commentary}[consequence]{Code commentary}

\newmdtheoremenv{conclusion}[consequence]{Conclusion}
\newmdtheoremenv{corollaire}[consequence]{Corollary}
\newmdtheoremenv{corrollaire}[consequence]{Corollary}
...
\newtheorem*{terminologie}{Terminology}
\newtheorem*{application}{Application}
\newtheorem*{uovt}{UOVT}
\newtheorem*{ex}{Exemple}
\newtheorem*{vraag}{Vraag}

\newmdtheoremenv[nobreak=true]{definition}[consequence]{Definition}
